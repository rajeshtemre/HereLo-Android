...
public class HereLoFragmentMainview extends Fragment implements View.OnClickListener {

    private final String TAG = HereLoFragmentMainview.class.getSimpleName();
...
//        _left1IV.setImageResource(R.drawable.grid_icon);
        ...
        shareLL = (LinearLayout) getView().findViewById(R.id.shareLL);
    ...
    /*
        ...
        if (mDataList != null) {
            if (mDataList.size() > 0) {
                ...
                adapter = new HomeMainAdapter(miniViewList,getActivity(),
                       null,
                        null,
                        null,
                        HereLoFragmentMainview.this,null,null, isFromMyProfile, mDataList);
