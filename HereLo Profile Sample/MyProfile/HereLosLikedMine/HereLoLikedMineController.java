package com.tv.herelo.MyProfile.HereLosLikedMine;
 ...
 */
public class HereLoLikedMineController {
    ...
    public HereLoLikedMineController(HereLoFragmentGridview mHereLoFragment) {
        this.mHereLoFragment = mHereLoFragment;
    }

    public HereLoLikedMineController(HereLoFragmentMiniview hereLoFragmentMiniview) {
        this.hereLoFragmentMiniview=hereLoFragmentMiniview;
    }

    public HereLoLikedMineController(HereLoFragmentMainview hereLoFragmentMainview) {
    ...
    class WSTask extends WebserviceTask {
        ...
        public String getWebserviceURL() {
            ...
            return WebserviceConstant.MAIN_BASE_URL + WebserviceConstant.getmyLikedHerelos;
        }
